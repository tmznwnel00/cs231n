...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params['W2'] = np.random.randn(num_filters * int(1 + (H - 2) / 2) * int(1 + (W - 2) / 2), hidden_dim) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        scores, score_cache = affine_forward(relu_out, W3, b3)
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(softmax_grad, score_cache)
